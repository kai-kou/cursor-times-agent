...
### Step 3.5: ユーザー確認（条件付き）

投稿タイプに応じて、投稿前のユーザー確認をスキップするかどうかを判断します。

#### 確認要否マッピング

| 投稿タイプ | ユーザー確認 | 理由 |
|-----------|------------|------|
| タスク完了振り返り | **必要** | メイン投稿のため内容確認が重要 |
| 最新情報共有 | **必要** | 情報の正確性確認が必要 |
| 進捗つぶやき | **スキップ** | 短いつぶやきで即時性が重要 |
| 息抜きつぶやき | **スキップ** | カジュアルな投稿で確認不要 |

#### 確認が必要な場合（タスク完了振り返り、最新情報共有）
...
```
2. ユーザーの応答を待つ
3. 承認された場合 → Step 4 へ進む
4. 修正要求の場合 → フィードバックに基づいて Step 3 を再実行

#### 確認をスキップする場合（進捗つぶやき、息抜きつぶやき）

- ユーザー確認なしで直接 Step 4 へ進む
- 完了報告（Step 5）で投稿内容を通知する
